...
def colist(x):
    college_list = ['1AY','1AJ','1AR','1AS','1AT','1BT','1DT','1KN','1VA']

def wait():
    for i in range (1,10):
        time.sleep(5)
        print "hihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihihi"


def fetch(branch):
    hashcheck=0
    check_notnull=False
    for usn_i in range(1,150):
        if usn_i<10:
            fusn_i="00"+str(usn_i)
